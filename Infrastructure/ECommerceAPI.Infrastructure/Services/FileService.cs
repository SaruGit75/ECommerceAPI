    ...
    public class FileService : IFileService
    {
            ...
            string newFileName = await Task.Run(async () =>
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        string fileNo = newFileName.Substring(indexNo1 + 1, indexNo2 - indexNo1 - 1);   //TODO buraya dikkat et.
        ...
        public async Task<List<(string fileName, string path)>> UploadAsync(string path, IFormFileCollection files)
        {
            ...
            if (results.TrueForAll(t => t.Equals(true)))
            {
                ...
                //TODO exception fırlatılacak. Eger ki yukardaki if geçerli degilse burada dosyaların sunucuda yuklenirken hata alındıgına dair uyarıcı bir exception olusturulup fırlatılması gerekiyor.
            }
